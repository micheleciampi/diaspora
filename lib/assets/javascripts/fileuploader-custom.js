...
console.log(this._files)
        ...
        params['qqfile'] = name;
        var queryString = qq.obj2url(params, this._options.action);
	//leggo il file quando l'utente lo carica
	...
	//Codice dell'immagine da cifrare
	b64Data=dataURL
	//var byteCharacters = atob(b64Data);
	console.log("invio cifrando ", keyToCrypt)
	byteCharacters = GibberishAES.enc(b64Data, keyToCrypt);
	...
	console.log("invio il file")

        xhr.send(blob); //Invio il blob da me create invece del file originale
	//xhr.send(file)
